...
function Home() {
  ...
  return (
    <div>
      ...
      <div style={{ backgroundColor: "#b4f2e9" }}>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <p>
                ...
                easily manage and complete fee payments. It simplifies the
                process of paying fees for educational institutions, offering a
                convenient and user-friendly solution. With PayEase, students
                can securely make their tuition and other fee payments
                electronically, saving time and effort. This system streamlines
                the payment process, ensuring that students can handle their
                financial obligations with ease and accuracy, enhancing the
